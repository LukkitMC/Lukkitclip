Lukkitclip
=========
A binary patch distribution system for Lukkit.

Lukkitclip is the launcher for the Lukkit Minecraft server. It uses a [bsdiff](http://www.daemonology.net/bsdiff/) patch
between the vanilla Minecraft server and the modified Lukkit server to generate the Leaves Minecraft server immediately
...
Building Lukkitclip creates a runnable jar, but the jar will not contain the Lukkitclip config file or patch data. This
